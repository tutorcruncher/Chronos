...
def send_webhooks(webhook: TCWebhook, user_agent: str, webhook_signature: str, url_extension: str = None) -> dict:
...
async def send_webhook_with_extension(
    ...
    :return:
    """
    return send_webhooks(webhook, user_agent, webhook_signature, url_extension)
...
async def send_webhook(
    ...
    :return:
    """
    return send_webhooks(webhook, user_agent, webhook_signature)
